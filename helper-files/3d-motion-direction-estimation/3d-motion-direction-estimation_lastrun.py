...
# Run 'Before Experiment' code from dot_motion
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/kbonnen/Library/CloudStorage/OneDrive-IndianaUniversity/Courses/V768-Measuring-Perception/V768-Psychophysics-labs/07-3d-motion/3d-motion-direction-estimation/3d-motion-direction-estimation_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    # Run 'Begin Experiment' code from dot_motion
    nDots = 1
    cubeSize = 3 # cm
    ...
    # Run 'Begin Routine' code from dot_motion
    ...
    rx_p/=20
    y_p/=20
    # Run 'Begin Routine' code from dot_appearance
    dotsL = []
    dotsR = []
    ...
    while continueRoutine:
        ...
        # Run 'Each Frame' code from dot_motion
        if dotsL[0].status == STARTED:
            # update 
            pass
        ...
        # Run 'Each Frame' code from dot_appearance
