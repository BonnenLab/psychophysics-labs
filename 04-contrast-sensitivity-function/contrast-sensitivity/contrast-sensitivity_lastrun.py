...
expName = 'contrast_sensitivity'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/kbonnen/Library/CloudStorage/OneDrive-IndianaUniversity/Courses/V768 - Measuring Perception/V768-Psychophysics-labs/04-contrast-sensitivity-function/contrast-sensitivity/contrast-sensitivity_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('contrast-sensitivity.csv'), 
        seed=None, 
    )
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[grating, fixation, response, fixation_response],
        )
        ...
        while continueRoutine:
            ...
            if response.status == NOT_STARTED and tThisFlip >= 0.6-frameTolerance:
                # keep track of start time/frame for later
            ...
            # if fixation_response is starting this frame...
            if fixation_response.status == NOT_STARTED and tThisFlip >= 0.6-frameTolerance:
                # keep track of start time/frame for later
                ...
                # update status
                fixation_response.status = STARTED
                fixation_response.setAutoDraw(True)
            
            # if fixation_response is active this frame...
