...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/StephMShields/Documents/Professional/Teaching/V768 Measuring Vision/psychophysics-labs/09-continuous-psychophysics/tracking/Bonnen2015_tracking_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        blob.y = []
        # keep track of which components have finished
        trialComponents = [response_mouse, blob_0, blob, cursor]
